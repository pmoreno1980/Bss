...
class MassEnable extends \Magento\Backend\App\Action
{
     ...
     * @return void
     */
    protected function enableTab($tabId)
    {
        try {
            $modelTab = $this->tabFactory->create();
            $modelTab->load($tabId);
            $modelTab->setStatus(self::BSS_ENABLE);
            $modelTab->save();
    ...
    /**
     * All Store View Enable Child Tab
     * @param int $storeId
     * @param int $tabId
     * @return void
     */
    protected function allStoreViewEnableChildTab($storeId, $tabId)
    {
        if ($storeId == 0) {
            /**
    ...
    public function execute()
    {
        ...
        foreach ($tabIds as $tabId) {
             ...
             * All Store View
             */
            $this->allStoreViewEnableChildTab($storeId, $tabId);
